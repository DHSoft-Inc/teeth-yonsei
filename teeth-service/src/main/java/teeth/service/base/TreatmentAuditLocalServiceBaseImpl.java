...
/**
 * Provides the base implementation for the treatment audit local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link teeth.service.impl.TreatmentAuditLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see teeth.service.impl.TreatmentAuditLocalServiceImpl
 * @generated
 */
public abstract class TreatmentAuditLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, TreatmentAuditLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TreatmentAuditLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TreatmentAuditLocalServiceUtil</code>.
	 */
	...
	public TreatmentAudit addTreatmentAudit(TreatmentAudit treatmentAudit) {
		...
		return treatmentAuditPersistence.update(treatmentAudit);
	}
	...
	public TreatmentAudit createTreatmentAudit(long AuditID) {
		return treatmentAuditPersistence.create(AuditID);
	}
	...
	public TreatmentAudit deleteTreatmentAudit(long AuditID)
		...
		return treatmentAuditPersistence.remove(AuditID);
	}
	...
	public TreatmentAudit deleteTreatmentAudit(TreatmentAudit treatmentAudit) {
		return treatmentAuditPersistence.remove(treatmentAudit);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TreatmentAudit.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return treatmentAuditPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return treatmentAuditPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return treatmentAuditPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return treatmentAuditPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public TreatmentAudit fetchTreatmentAudit(long AuditID) {
		return treatmentAuditPersistence.fetchByPrimaryKey(AuditID);
	}
	...
	public TreatmentAudit fetchTreatmentAuditByUuidAndGroupId(
		...
		return treatmentAuditPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public TreatmentAudit getTreatmentAudit(long AuditID)
		...
		return treatmentAuditPersistence.findByPrimaryKey(AuditID);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(treatmentAuditLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(TreatmentAudit.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(TreatmentAudit.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<TreatmentAudit>() {

				@Override
				public void performAction(TreatmentAudit treatmentAudit)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, treatmentAudit);
				}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return treatmentAuditLocalService.deleteTreatmentAudit(
			(TreatmentAudit)persistedModel);
	}

	public BasePersistence<TreatmentAudit> getBasePersistence() {
		return treatmentAuditPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return treatmentAuditPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<TreatmentAudit> getTreatmentAuditsByUuidAndCompanyId(
		...
		return treatmentAuditPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<TreatmentAudit> getTreatmentAuditsByUuidAndCompanyId(
		...
		return treatmentAuditPersistence.findByUuid_C(
	...
	public TreatmentAudit getTreatmentAuditByUuidAndGroupId(
		...
		return treatmentAuditPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<TreatmentAudit> getTreatmentAudits(int start, int end) {
		return treatmentAuditPersistence.findAll(start, end);
	}
	...
	public int getTreatmentAuditsCount() {
		return treatmentAuditPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TreatmentAuditLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		treatmentAuditLocalService = (TreatmentAuditLocalService)aopProxy;

		_setLocalServiceUtilService(treatmentAuditLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TreatmentAuditLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = treatmentAuditPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = TreatmentAuditLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, treatmentAuditLocalService);
		}
	...
	protected TreatmentAuditLocalService treatmentAuditLocalService;
