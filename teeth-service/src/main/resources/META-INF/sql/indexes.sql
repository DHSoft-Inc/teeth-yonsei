...
create index IX_788D9219 on treatment_audit (groupId, crfId, patientID, linkId, teethNum);
...
create index IX_BD290372 on treatment_history (groupId, crfId, patientID, linkId, teethNum, treatmentDate, treatment[$COLUMN_LENGTH:75$]);
