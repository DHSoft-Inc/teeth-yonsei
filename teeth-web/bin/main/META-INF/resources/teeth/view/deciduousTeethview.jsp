...
<div class="TeethView">
	...
	<div id="addTWrapper">
		...
		<aui:button-row>
			...
			<aui:button type="button" cssClass="btn btn-secondary" value="View Permanent Teeth" onClick="<%= ViewPermanentTeethURL.toString() %>" />
			<aui:button type="button" cssClass="btn btn-secondary" value="View Every Teeth" onClick="<%= ViewTotalTeethURL.toString() %>" />
		</aui:button-row>
	</div>
...
<!-- JS파일을 불러옴 -->
<script src="<%=request.getContextPath()%>/js/deciduous_teeth.js"></script>
